    ...
    <section id="integral-solver" style={{ padding: "60px 24px", background: C.bg }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {isDef && (!lo || !hi) && (
            <div style={{
              background: "#1a0a00", border: "1px solid #3a1f00", borderRadius: 8,
          ...
          {error && (
            <div style={{
              background: "#1a0505", border: "1px solid #4a0c0c", borderRadius: 8,
        ...
        {result && !loading && (
          <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 18, overflow: "hidden", marginBottom: 14 }}>
            ...
            <div style={{ padding: 24 }}>
              ...
              <div style={{
                fontSize: 15, color: "#fff", background: C.surface, borderRadius: 10,
              ...
              <div style={{
                fontSize: 22, color: C.yellow, background: "#0d0d00",
              ...
              {result.definite_value !== null && result.definite_value !== undefined && (lo && hi) && (
                <>
                  ...
                  <div style={{
                    fontSize: 18, color: "#97c459", background: "#070f02",
              ...
              {result.steps?.length > 0 && (
                <>
                  <div style={{
                    fontSize: 10, fontWeight: 800, letterSpacing: ".1em", color: C.muted,
                    textTransform: "uppercase", margin: "20px 0 10px"
                  }}>Các bước giải chi tiết</div>
...
export default function App() {
  ...
  return (
    <>
      ...
      {/* ── Tab switcher floating bar ── */}
      <div style={{
        position: "fixed", bottom: 28, left: "50%", transform: "translateX(-50%)",
        zIndex: 300, display: "flex", gap: 6,
        background: "rgba(10,10,10,0.85)", backdropFilter: "blur(20px)",
        border: "1px solid rgba(255,255,255,0.1)", borderRadius: 100,
        padding: "6px 8px", boxShadow: "0 8px 32px rgba(0,0,0,0.5)",
      }}>
        <button className="tab-btn" onClick={() => setPage("home")} style={{
          padding: "9px 22px", borderRadius: 100, border: "none", cursor: "pointer",
          fontFamily: "Manrope,sans-serif", fontWeight: 700, fontSize: 13,
          background: page === "home" ? "#FFE41F" : "transparent",
          color: page === "home" ? "#030303" : "#888",
        }}>🏠 Landing</button>
        <button className="tab-btn" onClick={() => setPage("tester")} style={{
          padding: "9px 22px", borderRadius: 100, border: "none", cursor: "pointer",
          fontFamily: "Manrope,sans-serif", fontWeight: 700, fontSize: 13,
          background: page === "tester" ? "linear-gradient(135deg,#00f2ff,#7000ff)" : "transparent",
          color: page === "tester" ? "#fff" : "#888",
        }}>🔍 Model Tester</button>
      </div>
