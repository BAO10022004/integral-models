...
export default function AuroraShader({
  ...
  useEffect(() => {
    ...
    // Ensure the canvas is positioned correctly and does not block interaction
    ...
    // Handle changes in container height (e.g. when calculation history loaded or added)
